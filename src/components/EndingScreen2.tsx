...
interface EndingScreen2Props {
  finalScore?: number;
  onRestart?: () => void;
  onMainMenu?: () => void;
}

export default function EndingScreen2({ 
  finalScore = 7500, 
  onRestart, 
  onMainMenu 
}: EndingScreen2Props) {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-8">
        <div className="flex flex-col items-center gap-15 max-w-screen w-full">
          ...
          <div className="flex flex-col items-center gap-12 w-full">
            ...
            <p className="text-white text-[43px] font-bold text-center leading-[1.2] max-w-[1149px] drop-shadow-[0px_2px_2px_rgba(148,107,199,1)]">
              You've made important progress protecting Singapore's coasts.
            </p>
          ...
          <div className="relative w-[1490px] max-w-full p-[43px] rounded-[56px] backdrop-blur-[37px] shadow-[0px_13px_63px_rgba(0,0,0,0.15)]">
            ...
            <style jsx>{`
              div::after {
                ...
                border-radius: 56px;
                padding: 5px;
                background: linear-gradient(135deg, #FFEEAF 0%, #FFFFFF 100%);
                -webkit-mask: 
            ...
            <div 
              ...
              style={{ backgroundColor: 'rgba(255, 238, 175, 0.3)' }}
            >
          ...
          <div className="flex gap-8 mt-8">
            {onRestart && (
              <button
                onClick={onRestart}
                className="px-12 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-bold text-2xl rounded-xl hover:from-yellow-600 hover:to-yellow-700 transition-all transform hover:scale-105 shadow-lg"
              >
                Try Again
              </button>
            )}
